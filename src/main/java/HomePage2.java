	...
	public HomePage2() {
		...
		menu_hoa_don.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					String[] columnNames = { "Hóa đơn", "Mã phòng", "Mã khách", "Mã loại", "Đơn giá", "Ngày thuê",
							"Ngày trả", "Số ngày", "Tổng tiền" };
					DefaultTableModel tableModel = new DefaultTableModel(columnNames, 0);
					tableModel.addRow(columnNames);
					int size = 0;
					while (rs.next()) {
		...
		btn_export.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				run_for_header.setText("Khách sạn ABC");
				run_for_header.addBreak();
				run_for_header.setText("Hóa đơn giá trị gia tăng");
				run_for_header.addBreak();
				String MaHD = (String) table_3.getValueAt(table_3.getSelectedRow(), 0);
				run_for_header.setText("Mã hóa đơn: " + MaHD);
				...
				run_for_content.setText("Mã phòng: "+MaPhong);
				run_for_content.addBreak();
				run_for_content.setText("Mã khách: "+MaKhach);
				run_for_content.addBreak();
				run_for_content.setText("Mã loại: "+MaLoai);
				run_for_content.addBreak();
				run_for_content.setText("Đơn giá: "+DonGia);
				run_for_content.addBreak();
				run_for_content.setText("Ngày thuê: "+Thue);
				run_for_content.addBreak();
				run_for_content.setText("Ngày trả: "+Tra);
				run_for_content.addBreak();
				run_for_content.setText("Số ngày: "+Ngay);
				run_for_content.addBreak();
				run_for_content.setText("-------------------------------------------------");
				run_for_content.addBreak();
				run_for_content.setText("Tổng tiền: "+Tien);
				run_for_content.addBreak();
				...
				run_for_footer.setText("Chữ ký lễ tên");
				...
				try {
					...
					out.close();
					document.close();
					JOptionPane.showMessageDialog(table_3, "Xuất hóa đơn thành công");
