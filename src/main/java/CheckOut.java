...
public class CheckOut extends JFrame {
	 ...
	 * Create the frame.
	 */
	public CheckOut(String MaPhieu) {
		...
		JLabel txt_ma_phong_tra = new JLabel("");
		...
		try {
			...
			PreparedStatement stt = conn.prepareStatement("select t.*, l.MaLoai , l.DonGia,datediff(NgayTra,NgayThue) as SoNgay, (datediff(NgayTra,NgayThue) * l.DonGia) as TongTien from thuephong t \r\n" + 
